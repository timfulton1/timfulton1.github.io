...
![](assets/plot_aging_100.png){fig-align="center" width=100% fig-alt="A scatterplot that displays the number of athletes with sub 10 second performances across ages 18 to 40" group="my-gallery"}

![](assets/ncaa_cross_plot.png){fig-align="center" width=100% fig-alt="A scatterplot that displays the team who won the NCAA Cross Country Championshps each year" group="my-gallery"}
...
![](assets/steps_per_day.png){fig-align="center" width=90% fig-alt="Description of the image" group="my-gallery"}
...
![](assets/endowments.png){fig-align="center" width=90% fig-alt="A tree map that displays university endowments" group="my-gallery"}
